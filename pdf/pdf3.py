...
pdf.multi_cell(80, h=-10, txt="""def multi_cell(self, w, h=None, \ntxt='', border=0, align=Align.J, fill=False, split_only=False, link='', ln='DEPRECATED', max_line_height=None, markdown=False, print_sh=False, new_x=XPos.RIGHT, new_y=YPos.NEXT)""")
